...
export default function Sidebar({ balance, totalValue, dayPnl }: Prop) {
  return (
    <aside className="hidden md:block bg-bg-main w-[300px] sticky top-22 h-fit">
        ...
        <div className="border border-border rounded-xl p-6">
          <div className="space-y-4 flex flex-col gap-6">
            ...
            <div className="mb-2">
                ...
                <Link href="/portfolio" className="rounded-md py-2 px-3 border border-border">View Details</Link>
            </div>
